    ...
    Profiles:
      ...
      - ProfileName: intelx
        ...
        SpotFleetTypes:
          ...
          - xiezn
        EnableHyperthreading: false
      - ProfileName: intelhighfreq
        NodeGroupName: intelhighfreq
        MaxControllers: 10
        InstanceTypes:
          - m5zn
          - r7iz
